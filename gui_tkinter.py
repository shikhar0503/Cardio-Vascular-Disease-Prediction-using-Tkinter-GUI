...
def test():
    ...
    if result[0] == 1:
        ...
        Label(win, text="                                                              ", fg="red", bg="white",
              font=("Calibri 12 bold")).place(x=12, y=610)
        Label(win, text=user, fg="red", bg="white", font=("Calibri 12 bold")).place(x=12, y=610)
        MsgBox = tk.messagebox.showwarning('warning',
                                           'Cardio-Vascular Problem Found!! \nEat Vegetables, Fruits, Milk Products, Fish, Sugar With Honey!! \nReport is saved by Persons Name',
                                           icon='warning')
        ...
        MsgBox = tk.messagebox.showinfo('information',
                                        'Cardio-Vascular Problem Not Found!! \nPateint is at Less Risk!! \nEat Vegetables, Fruits, Milk Products, Fish, Sugar With Honey!! \nReport is saved by Persons Name',
                                        icon='info')
...
win.title("Cardio Disease Prediction By Shikhar Katyayan")
win.iconbitmap('1.ico')


title = Label(win, text="Cardio Disease Prediction", bg="gray", width="30", height="2", fg="White",
...
Normal = Radiobutton(win, text="Normal", bg="cyan", variable=cholesterol, value=1, font=("Verdana 12")).place(x=12,
                                                                                                              y=400)
Above_Normal = Radiobutton(win, text="Above_Normal", bg="cyan", variable=cholesterol, value=2,
                           font=("Verdana 12")).place(x=100, y=400)
Well_Above_Normal = Radiobutton(win, text="Well_Above_Normal", bg="cyan", variable=cholesterol, value=3,
                                font=("Verdana 12")).place(x=250, y=400)
...
Above_Normal = Radiobutton(win, text="Above_Normal", bg="cyan", variable=gluc, value=2, font=("Verdana 12")).place(
    x=100, y=460)
Well_Above_Normal = Radiobutton(win, text="Well_Above_Normal", bg="cyan", variable=gluc, value=3,
                                font=("Verdana 12")).place(x=250, y=460)
